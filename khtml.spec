...
Source0  : https://download.kde.org/stable/frameworks/5.88/portingAids/khtml-5.88.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/5.88/portingAids/khtml-5.88.0.tar.xz.sig
Summary  : KHTML APIs
...
%prep
%setup -q -n khtml-5.88.0
cd %{_builddir}/khtml-5.88.0
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1637012624
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/khtml-5.88.0/COPYING.GPL3 %{buildroot}/usr/share/package-licenses/khtml/8624bcdae55baeef00cd11d5dfcfa60f68710a02
cp %{_builddir}/khtml-5.88.0/COPYING.LGPL-2 %{buildroot}/usr/share/package-licenses/khtml/ba8966e2473a9969bdcab3dc82274c817cfd98a1
cp %{_builddir}/khtml-5.88.0/COPYING.LIB %{buildroot}/usr/share/package-licenses/khtml/9a1929f4700d2407c70b507b3b2aaf6226a9543c
pushd clr-build
%make_install
popd
%find_lang khtml5
...
/usr/lib64/libKF5KHtml.so.5.88.0
