...
Source0  : https://download.kde.org/stable/frameworks/5.115/portingAids/khtml-5.115.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/5.115/portingAids/khtml-5.115.0.tar.xz.sig
Summary  : KHTML APIs
...
%prep
%setup -q -n khtml-5.115.0
cd %{_builddir}/khtml-5.115.0
%patch -P 1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1707765391
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libKF5KHtml.so.5.115.0
...
/usr/lib64/libKF5KHtml.so.5.115.0
