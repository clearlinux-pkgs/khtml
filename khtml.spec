...
Source0  : https://download.kde.org/stable/frameworks/5.105/portingAids/khtml-5.105.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/5.105/portingAids/khtml-5.105.0.tar.xz.sig
Summary  : KHTML APIs
...
%prep
%setup -q -n khtml-5.105.0
cd %{_builddir}/khtml-5.105.0
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1681752112
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libKF5KHtml.so.5.105.0
